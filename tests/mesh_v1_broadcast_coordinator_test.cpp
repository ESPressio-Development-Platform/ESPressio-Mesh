 ...
 * - PermitIdentityVerification (bool): 1 bytes [0 bytes dynamic allocation]
 ...
 * - LastPayload (std::array<std::uint8_t, 16>): 16 bytes [0 bytes dynamic allocation]
