...
public:
    ...
    bool DeriveSession(ESPressio::Mesh::MeshEphemeralKeyHandle, const ESPressio::Mesh::MeshEphemeralPublicKey&, const ESPressio::Mesh::MeshIdentifier&, const ESPressio::System::DeviceIdentifier&, const ESPressio::Mesh::MembershipIncarnation&, const ESPressio::Mesh::MeshHandshakeNonce&, const ESPressio::System::DeviceIdentifier&, const ESPressio::Mesh::MembershipIncarnation&, const ESPressio::Mesh::MeshHandshakeNonce&, const ESPressio::Mesh::MeshSecurityDigest&, ESPressio::Mesh::MeshSecuritySessionRole, ESPressio::Mesh::MeshSecuritySessionHandle&, ESPressio::Mesh::MeshSecuritySessionIdentifier&) noexcept override { return false; }
