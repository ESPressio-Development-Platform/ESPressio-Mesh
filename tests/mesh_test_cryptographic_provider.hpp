 ...
 * Members:
 * - Releases (std::size_t): 4 bytes [0 bytes dynamic allocation]
 * - Resets (std::size_t): 4 bytes [0 bytes dynamic allocation]
 * - PermitRelease (bool): 1 bytes [0 bytes dynamic allocation]
