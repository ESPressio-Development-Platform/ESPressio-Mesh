...
/// <summary>
/// Wire-neutral composition helpers joining Radio submission, authenticated next-hop Mesh acceptance and bounded route
/// attempt policy without collapsing their meanings.
/// </summary>
/// <remarks>
/// An accepted Radio submission always becomes AwaitingNextHopAcceptance, regardless of whether Radio also proved
/// transmission completion or link-layer peer acknowledgement. Only `ForwardingAcceptanceResult::Committed`, which is
/// produced after exact authenticated next-hop DeviceIdentifier + MembershipIncarnation + MeshMessageId acceptance,
/// becomes `RouteAttemptOutcome::Delivered`.
///
...
public:
    /// <summary>
    /// Evaluates one synchronous forwarding submission result. Accepted work remains pending for Mesh-level next-hop
    /// acceptance and therefore never invokes route-attempt completion at this stage.
    /// </summary>
    ...
    /// <summary>
    /// Evaluates the result of already-authenticated next-hop acceptance processing.
    /// </summary>
